const languageData = {
  en: {
    ...
    contact: {
      title: "Get in touch",
      firstHeading:
        "Wether you want to ask any questions or just want to say hi,",
    ...
    about: {
      title: "About",
      text1:
        "Hey there, I'm Nuria, a frontend developer who's all about building cool stuff.",
      text2:
        "I've always had a knack for creating things, and that's what drew me to the world of websites and applications.",
      text3:
        "HTML, CSS, and JavaScript? They're my go-to tools. I love using frameworks like React, and I'm currently diving into Typescript to level up my skills.",
      text4:
        "My real passion lies in crafting apps that make people's lives better, adding those special touches that enhance the user experience ✨",
      text5:
        "I'm constantly on the lookout for new things to learn and ways to grow. When I'm not coding, you'll find me sketching illustrations or chilling with my cat, Eris.",
    },
    projectsTitle: "Work",
    projects: [
      {
      ...
      {
        title: "Oakea",
        text: "I recently developed Oakea, an e-commerce website built using TypeScript and React. This app includes features such as the ability to maintain a favorite products list and a shopping cart modal. The codebase is well-structured, utilizing modular components that can easily scale for future expansion.",
        image: "./oakea.png",
        tags: ["Typescript", "React"],
        link: "https://oakea.netlify.app/",
        github: "https://github.com/nutaptap/oakea",
      },
      {
        title: "Pomoglobo",
  ...
  es: {
    ...
    contact: {
      title: "Contacto",
      firstHeading:
        "Tanto si quieres hacerme alguna pregunta o simplemente saludar,",
    ...
    about: {
      title: "Sobre mi",
      text1:
        "Hola, soy Nuria, una desarrolladora frontend que está enfocada en construir cosas geniales.",
      text2:
        "Siempre me ha encantado crear cosas, y eso fue lo que me imulsó a adentrarme en el mundo de la programación de webs y aplicaciones.",
      text3:
        "¿HTML, CSS y JavaScript? Son mis herramientas principales. Me encanta utilizar frameworks como React, y actualmente estoy explorando TypeScript para mejorar mis habilidades.",
      text4:
        "Mi verdadera pasión radica en diseñar aplicaciones que mejoren la vida de las personas, añadiendo esos pequeños detalles que mejoran la experiencia del usuario ✨",
      text5:
        "Siempre estoy en busca de nuevas cosas para aprender y formas de crecer. Cuando no estoy programando, me encontrarás dibujando ilustraciones o relajándome con mi gata, Eris.",
    },
    ...
    projects: [
      ...
      {
        title: "Oakea",
        text: "Recientemente desarrollé Oakea, una web de e-commerce construida con TypeScript y React. Esta aplicación incluye una lista de productos favoritos y un modal de carrito de compras. El código está bien estructurado, utilizando componentes modulares que pueden ampliarse fácilmente para futuras expansiones.",
        image: "./oakea.png",
        tags: ["Typescript", "React"],
        link: "https://oakea.netlify.app/",
        github: "https://github.com/nutaptap/oakea",
  ...
  ca: {
    ...
    about: {
      title: "Sobre mi",
      text1:
        "Hola, sóc la Nuria, una desenvolupadora frontend que està enfocada a construir coses genials.",
      text2:
        "Em vaig interessar per la programació perquè sempre m'ha agradat construir coses i em va atraure la idea de crear llocs web i aplicacions.",
      text3:
        "HTML, CSS i JavaScript? Són les meves eines principals. M'encanta utilitzar frameworks com React, i actualment estic explorant TypeScript per millorar les meves habilitats.",
      text4:
        "M'apassiona dissenyar aplicacions que milloren la vida de les persones, afegint aquests petits detalls que milloren l'experiència de l'usuari ✨",
      text5:
        "Sempre estic buscant noves coses per aprendre i formes de créixer. Quan no estic programant, em trobaràs dibuixant il·lustracions o relaxant-me amb la meva gata, Eris.",
    },
    ...
    projects: [
      ...
      {
        title: "Oakea",
        text: "Recentment he desenvolupat Oakea, una web 'e-commerce construïda amb TypeScript i React. Aquesta aplicació inclou una llista de productes favorits i un modal de carret de compra. El codi està ben estructurat, utilitzant components modulars que es poden ampliar fàcilment per a futures expansions.",
        image: "./oakea.png",
        tags: ["Typescript", "React"],
        link: "https://oakea.netlify.app/",
        github: "https://github.com/nutaptap/oakea",
